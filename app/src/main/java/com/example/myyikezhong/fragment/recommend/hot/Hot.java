package com.example.myyikezhong.fragment.recommend.hot;
...
import com.example.myyikezhong.fragment.recommend.hot.adapter.HotAdapter;
        ...
        hotVideos.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    //设置适配器
                    HotAdapter adapter = new HotAdapter(data,getActivity());
                    mRvHot.setAdapter(adapter);
                    mRvHot.setLayoutManager(new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL,false));
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
