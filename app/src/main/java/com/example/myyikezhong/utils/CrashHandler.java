package com.example.myyikezhong.utils;
...
import com.example.myyikezhong.MainActivity;
...
/**
 * 错误报告发送自己的服务器一份,腾讯Bugly帮我们捕捉
 * UncaughtException处理类,当程序发生Uncaught异常的时候,有该类来接管程序,程序闪退再重新打开程序,并记录发送错误报告.
 * 使用步骤:
